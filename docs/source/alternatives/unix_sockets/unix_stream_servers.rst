...
.. tabs::
   ...
   .. group-tab:: Synchronous
      ...
      #. Derive a class from :class:`.BlockingStreamRequestHandler` and redefine its :meth:`~.BlockingStreamRequestHandler.handle` method;
         this method will process incoming requests.

      #. Instantiate the :class:`.ThreadedUnixStreamServer` class passing it the server's address, the :term:`protocol object`
         and the request handler instance.

      #. Call :meth:`~.ThreadedUnixStreamServer.serve_forever` to process requests.
...
.. tabs::
   ...
   .. group-tab:: Synchronous
      ...
      You can override :meth:`~.BlockingStreamRequestHandler.on_connection` and :meth:`~.BlockingStreamRequestHandler.on_disconnection` methods:

      * :meth:`~.BlockingStreamRequestHandler.on_connection` is called on client task startup.
...
.. tabs::
   ...
   .. group-tab:: Synchronous
      ...
      The server will call :meth:`~.BlockingStreamRequestHandler.service_init` and pass it an :class:`~contextlib.ExitStack`
      at the beginning of the :meth:`~.ThreadedUnixStreamServer.serve_forever` task to set up the global service.
...
.. tabs::
   ...
   .. group-tab:: Synchronous
      ...
      .. tip::
         ...
         It is possible to initialize the context to be copied in :meth:`~.BlockingStreamRequestHandler.service_init`.
      ...
      .. warning::
         ...
         There is no context isolation between :meth:`~.BlockingStreamRequestHandler.handle` calls.

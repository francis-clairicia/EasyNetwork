...
.. tabs::
   ...
   .. group-tab:: Synchronous
      ...
      #. Instantiate the :class:`.ThreadedTCPNetworkServer` class passing it the server's address, the :term:`protocol object`
         and the request handler instance.

      #. Call :meth:`~.ThreadedTCPNetworkServer.serve_forever` to process requests.
...
.. tabs::
   ...
   .. group-tab:: Synchronous
      ...
      at the beginning of the :meth:`~.ThreadedTCPNetworkServer.serve_forever` task to set up the global service.

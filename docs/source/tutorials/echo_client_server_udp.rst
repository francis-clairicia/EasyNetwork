...
.. tabs::
   ...
   .. group-tab:: Asynchronous
      ...
      .. literalinclude:: ../_include/examples/tutorials/echo_client_server_udp/async_server.py
         :linenos:
         :caption: server.py
...
.. tabs::
   ...
   .. group-tab:: Asynchronous
      ...
      .. literalinclude:: ../_include/examples/tutorials/echo_client_server_udp/async_client.py
         :linenos:
         :caption: client.py

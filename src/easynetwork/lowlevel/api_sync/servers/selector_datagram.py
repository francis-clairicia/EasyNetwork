...
class SelectorDatagramServer(_transports.BaseTransport, Generic[_T_Request, _T_Response, _T_Address]):
        ...
        *,
        ...
        with self.__serve_guard, contextlib.ExitStack() as stack:
            ...
            try:
                ...
                datagram_receiver_thread_name = datagram_receiver_thread_name.strip()
    ...
    def __serve_requests__start_new_client_task(
        ...
        *,
        ...
        client_task_future = self.__serve_request__run_client_function_in_executor(
        ...
        try:
            with task_exit_stack.pop_all() as task_exit_stack:
                ...
                waiter_future.add_done_callback(
                    functools.partial(
                        self.__serve_requests__when_waiter_is_ready,
                        client_ctx=client_ctx,
                        client_data=client_data,
    ...
    def __serve_request__run_client_function_in_executor(
        ...
        executor: concurrent.futures.Executor,
        *,
        task_exit_stack: contextlib.ExitStack | None,
        ...
        if task_exit_stack is not None:
    ...
    def __serve_requests__when_waiter_is_ready(
        self,
        ...
        *,
        ...
        self.__serve_request__run_client_function_in_executor(handler, executor, task_exit_stack=task_exit_stack)

...
class SelectorStreamServer[Request, Response](_transports.BaseTransport):
    ...
    def serve(
        self,
        client_connected_cb: Callable[[ConnectedStreamClient[Response]], Generator[RecvParams | None, Request]],
...
class _RequestReceiver[Request](_BaseRequestReceiver[Request]):
    ...
    def next_with_ancillary(self, ancillary_data_params: RecvAncillaryDataParams, *, first_try: bool) -> Request:

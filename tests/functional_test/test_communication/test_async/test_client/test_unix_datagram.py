...
class TestAsyncUnixDatagramClient:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param("ABSTRACT", marks=PlatformMarkers.abstract_sockets_supported),
        ],
        indirect=True,
    )
    async def test____aclose____idempotent(self, client: AsyncUnixDatagramClient[str, str]) -> None:
        unix_socket_path = client.get_local_name().as_pathname()
    ...
    @pytest.mark.parametrize("unix_datagram_socket_factory", ["PATHNAME"], indirect=True)
...
class TestAsyncUnixDatagramClientConnection:
    ...
    @PlatformMarkers.abstract_sockets_supported

...
if sys.platform != "win32":
    ...
    class TestUnixDatagramClient(BaseTestClient):
        ...
        def test____dunder_init____use_given_socket____default(
            ...
            # Act
            client = UnixDatagramClient[Any, Any](
                mock_unix_datagram_socket, mock_datagram_protocol, retry_interval=retry_interval
            )
            request.addfinalizer(client.close)
        ...
        def test____dunder_del____ResourceWarning(
            ...
            # Arrange
            client: UnixDatagramClient[Any, Any] = UnixDatagramClient(  # noqa: F841
                mock_unix_datagram_socket, mock_datagram_protocol
            )

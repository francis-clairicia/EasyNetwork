...
from easynetwork.lowlevel.socket import SocketAttribute, SocketProxy, TLSAttribute, UnixCredentials, UNIXSocketAttribute
...
class TestSocketStreamTransport(BaseTestSocketTransport, MixinTestSocketSendMSG):
    ...
    def test____dunder_init____default(
        ...
        if mock_stream_socket.family == AF_UNIX_or_skip():
